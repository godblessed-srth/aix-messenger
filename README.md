...
Clone my repository with the command "git clone https://github.com/godblessed-srth/aix-messenger.git", then navigate to the project folder, install SDK on your PC (depending on your distribution) and run the installer './install.sh'
